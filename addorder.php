          ...
          <form role="form" action="" method="post" class="form-horizontal">
            <div class="box-body">
              ...
              <table class="table table-bordered" id="product_info_table">
                ...
                <tbody>
                  <tr id="row_1">
                    ...
                    <td>
                        <input type="text" name="rate" id="rate_1" class="form-control" value="<?php ?>"  autocomplete="off">
                    ...
                    <td><button type="button" class="btn btn-default" onclick="removeRow('1')"><i class="far fa-close"></i></button></td>
                    </tr>
                  </tbody>
              </table>
              <br /> <br/>
              ...
              <div class="col-md-6 col-xs-12">
                ...
                <div class="form-group">
                  <label for="vat_charge" class="col-sm-5 control-label">Vat <?php 
                $sql = "SELECT * FROM restaurant_info WHERE id =1";
                $res = $mysqli->query($sql);
                while($row = $res->fetch_assoc()){
                  echo $row['vat_charge_value'];} ?> %</label>
                  <div class="col-sm-7">
            ...
            <div class="box-footer float-none">
